...
});window.jQuery = jquery;function styleInject(css, ref) {
  if ( ref === void 0 ) ref = {};
  ...
  methods: {
    ...
    bindEvents: function bindEvents() {
      ...
      this.events.forEach(function (eventName) {
        _this2.owl.on("".concat(eventName, ".owl.carousel"), function (event) {
          _this2.$emit(eventName, event); // console.log(eventName)
...
var __vue_render__ = function __vue_render__() {
  ...
  return _c('div', [_vm._ssrNode("<div" + _vm._ssrAttr("id", _vm.elementHandle) + " class=\"owl-carousel owl-theme\">", "</div>", [_vm._t("default")], 2)]);
};
